...
namespace NayanTraders.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PurchaseCode,PurchaseDate,VendorId,total")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PurchaseCode,PurchaseDate,VendorId,total")] Purchase purchase)
        {
            if (ModelState.IsValid)
            {
